...
class GApiResponse {
    ...
    class PlaceInfo {
        ...
        class func initWithData(_ data:[String:Any]) -> PlaceInfo {
            ...
            object.phone = data["formatted_phone_number"] as? String
            ...
            if let photoslist = data["photos"] as? Array<Any>{
                
                for inx in 0..<photoslist.count{
                    
                    if let photosDic = photoslist[inx] as? NSDictionary
                    {
                        restImage.append(photosDic.value(forKey: "photo_reference") as? String ?? "")
                    }
                    
                }
            }
            
            object.photo_reference = restImage
    ...
    class NearBy {
        ...
        class func initWithData(_ data:[String:Any]) -> NearBy {
            ...
            object.rating = data["rating"] as? Int
            object.ratingFloat = data["rating"] as? Double
            object.description = data["vicinity"] as? String
            object.user_ratings_total = data["user_ratings_total"] as? Int
            object.types = data["types"] as? [String] ?? []
            ...
            if  let opening_hours = data["opening_hours"] as? type {
                object.open_now = opening_hours["open_now"] as? Int
            }
            return object
        }
    }
...
class GoogleApi : NSObject {
    ...
    func getUrl(_  usedFor:UsedFor,input:String) -> String {
        ...
        case .placeInformation:
            ...
            return String(format: "%@?fields=&place_id=%@&key=%@",GoogleUrl.placeInfo.rawValue,input,googleApiKey)
        case .reverseGeo:
    ...
    func getConvertedInputFor(_ usedFor:UsedFor,input:GInputParams) -> String {
        switch usedFor {
    ...
    func callApi(_ api : UsedFor = .autocomplete,input:GInputParams,completion: @escaping GCallback) {
